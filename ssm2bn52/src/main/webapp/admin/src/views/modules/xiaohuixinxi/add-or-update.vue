          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="销毁原因" prop="xiaohuiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="销毁原因"
                  v-model="ruleForm.xiaohuiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaohuiyuanyin" label="销毁原因" prop="xiaohuiyuanyin">
                    <span>{{ruleForm.xiaohuiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='xiaohuiyuanyin'){
            this.ruleForm.xiaohuiyuanyin = obj[o];
	    this.ro.xiaohuiyuanyin = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `xiaohuixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaohuixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
