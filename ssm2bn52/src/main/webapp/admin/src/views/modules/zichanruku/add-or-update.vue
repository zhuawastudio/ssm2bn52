      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="物品类型" prop="wupinleixing">
          <el-input v-model="ruleForm.wupinleixing" 
              placeholder="物品类型" clearable  :readonly="ro.wupinleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品类型" prop="wupinleixing">
              <el-input v-model="ruleForm.wupinleixing" 
                placeholder="物品类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买公司" prop="goumaigongsi">
          <el-input v-model="ruleForm.goumaigongsi" 
              placeholder="购买公司" clearable  :readonly="ro.goumaigongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买公司" prop="goumaigongsi">
              <el-input v-model="ruleForm.goumaigongsi" 
                placeholder="购买公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买价格" prop="goumaijiage">
          <el-input v-model="ruleForm.goumaijiage" 
              placeholder="购买价格" clearable  :readonly="ro.goumaijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买价格" prop="goumaijiage">
              <el-input v-model="ruleForm.goumaijiage" 
                placeholder="购买价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.zongjiage" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="入库日期" prop="rukuriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.rukuriqi" label="入库日期" prop="rukuriqi">
              <el-input v-model="ruleForm.rukuriqi" 
                placeholder="入库日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                    zongjiage:{
                                                                                                                                                                        get: function () {
        return 1*this.ruleForm.goumaijiage*this.ruleForm.kucun
      }
    },
                                                  },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupinleixing = true;
            continue;
	            	            ...
	            	            if(o=='goumaigongsi'){
            this.ruleForm.goumaigongsi = obj[o];
	    this.ro.goumaigongsi = true;
            continue;
          }
	            	            if(o=='goumaijiage'){
            this.ruleForm.goumaijiage = obj[o];
	    this.ro.goumaijiage = true;
            continue;
          }
	            	            if(o=='kucun'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `zichanruku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichanrukuCrossAddOrUpdateFlag = false;
                  this.parent.search();
