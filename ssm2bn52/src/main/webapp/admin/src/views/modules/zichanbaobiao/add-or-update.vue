          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="固定资产" prop="gudingzichan">
          <el-input v-model="ruleForm.gudingzichan" 
              placeholder="固定资产" clearable  :readonly="ro.gudingzichan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="固定资产" prop="gudingzichan">
              <el-input v-model="ruleForm.gudingzichan" 
                placeholder="固定资产" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="无形资产" prop="wuxingzichan">
          <el-input v-model="ruleForm.wuxingzichan" 
              placeholder="无形资产" clearable  :readonly="ro.wuxingzichan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="无形资产" prop="wuxingzichan">
              <el-input v-model="ruleForm.wuxingzichan" 
                placeholder="无形资产" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他资产" prop="qitazichan">
          <el-input v-model="ruleForm.qitazichan" 
              placeholder="其他资产" clearable  :readonly="ro.qitazichan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他资产" prop="qitazichan">
              <el-input v-model="ruleForm.qitazichan" 
                placeholder="其他资产" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总资产" prop="zongzichan">
            <el-input v-model="zongzichan"
                placeholder="总资产" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongzichan" label="总资产" prop="zongzichan">
              <el-input v-model="ruleForm.zongzichan" 
                placeholder="总资产" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
                                                                zongzichan: {
                                                                                                                                                                                                                    get: function () {
        return 0+parseFloat(this.ruleForm.gudingzichan)+parseFloat(this.ruleForm.wuxingzichan)+parseFloat(this.ruleForm.qitazichan) || ''
      }
    },
                                              },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mingcheng = true;
            continue;
	            	            ...
	            	            if(o=='gudingzichan'){
            this.ruleForm.gudingzichan = obj[o];
	    this.ro.gudingzichan = true;
            continue;
          }
	            	            if(o=='wuxingzichan'){
            this.ruleForm.wuxingzichan = obj[o];
	    this.ro.wuxingzichan = true;
            continue;
          }
	            	            if(o=='qitazichan'){
            this.ruleForm.qitazichan = obj[o];
	    this.ro.qitazichan = true;
            continue;
          }
	            	            if(o=='zongzichan'){
            this.ruleForm.zongzichan = obj[o];
	    this.ro.zongzichan = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
              this.ruleForm.zongzichan = this.zongzichan
                              // ${column.compare}
                              // ${column.compare}
                              // ${column.compare}
        ...
        if (valid) {
          this.$http({
            url: `zichanbaobiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichanbaobiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
